...
-- USER CHANGED
    ...
    awful.key({ modkey }, "n", function () awful.util.spawn("subl") end,
              {description = "start Sublime Text", group = "launcher"}),

    -- VSCodium
    awful.key({ modkey }, "c", function () awful.util.spawn("codium") end,
            {description = "start VSCodium", group = "launcher"}),
